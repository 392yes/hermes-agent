...
def init_agent(
    ...
    # Gateway status_callback is not yet wired, so serious compression warnings
    # are still stored elsewhere for replay.  Do NOT replay the benign Codex
    # gpt-5.5 autoraise notice into Slack/Telegram/etc.; it is noisy in
    # conversation channels and users can inspect/override the config manually.
