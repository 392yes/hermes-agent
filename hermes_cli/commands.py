...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("claude-account", "Switch the Claude account for this CLI pane only",
               "Configuration", cli_only=True, aliases=("cc-account",),
               args_hint="[selector|status]", subcommands=("default", "status")),
